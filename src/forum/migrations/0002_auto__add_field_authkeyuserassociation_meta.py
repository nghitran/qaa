...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthKeyUserAssociation.meta'
        db.add_column('forum_authkeyuserassociation', 'meta',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthKeyUserAssociation.meta'
        db.delete_column('forum_authkeyuserassociation', 'meta')
    ...
    models = {
        ...
        'forum.authkeyuserassociation': {
            ...
            'meta': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'}),
